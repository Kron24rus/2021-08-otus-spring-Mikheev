...
SELECT SETVAL((SELECT PG_GET_SERIAL_SEQUENCE('"authors"', 'id')), (SELECT (MAX("id") + 1) FROM "authors"), FALSE);
SELECT SETVAL((SELECT PG_GET_SERIAL_SEQUENCE('"genres"', 'id')), (SELECT (MAX("id") + 1) FROM "genres"), FALSE);
SELECT SETVAL((SELECT PG_GET_SERIAL_SEQUENCE('"books"', 'id')), (SELECT (MAX("id") + 1) FROM "books"), FALSE);
SELECT SETVAL((SELECT PG_GET_SERIAL_SEQUENCE('"comments"', 'id')), (SELECT (MAX("id") + 1) FROM "comments"), FALSE);
